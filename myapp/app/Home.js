    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.bottom}>
                ...
                <TouchableOpacity style={styles.button}><Text style={styles.buttonText}>Measure your StessLevels</Text></TouchableOpacity>
            </View>
        </ScrollView>
    );
};
...
const styles = StyleSheet.create({
    ...
    profileImage: { width: 60, height: 60, borderRadius: 40, borderColor: '#000000', borderWidth: 2 },
